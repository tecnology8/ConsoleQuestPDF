...
using WebQuestPDF.Models;
using QuestPDF.Fluent;
using QuestPDF.Helpers;
using QuestPDF.Previewer;

namespace WebQuestPDF.Controllers
{
            ...
            var data = Document.Create(document =>
             {
                 document.Page(page =>
                 {
                     ...
                     page.Header().ShowOnce().Row(row =>
                     {
                         ...
                         //Poner Imagen al Reporte
                         var rutaImagen = Path.Combine(_host.WebRootPath, "images/DelCaribeLogo.png");
